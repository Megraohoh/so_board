...
def get_user_profile(request, pk):
    ...
    user_players = user.current_user.favorite_player.all()
    return render(request, 'loggedin_detail.html', {"user":user, "user_games": user_games, "user_players": user_players})
